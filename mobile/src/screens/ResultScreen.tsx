        ...
        <Card.Content style={{ gap: SP.lg }}>
          <View style={s.detectedRow}>
            ...
            <View style={{ flex: 1, gap: SP.xs }}>
              <Text variant="headlineMedium" style={s.vegName}>{name}</Text>
          ...
          <View style={{ gap: SP.sm }}>
            ...
            <ProgressBar progress={confidence} color={confColor} style={s.progressBar} />
          </View>
        ...
        <Card style={s.card}>
          <Card.Content style={{ gap: SP.md }}>
            <View style={s.cardHead}>
              ...
              <Text variant="titleMedium" style={s.cardTitle}>Current Market Price</Text>
            </View>
            ...
            {current_price.min_price != null && current_price.max_price != null && (
              <View style={s.priceRange}>
                <View style={s.rangeItem}>
                  ...
                  <Text variant="titleSmall" style={{ color: C.green, fontWeight: '700' }}>
                    ₹{current_price.min_price.toFixed(0)}
                  </Text>
                </View>
                <Divider style={{ width: 1, height: 36, backgroundColor: C.border }} />
                <View style={s.rangeItem}>
                  <Text variant="labelSmall" style={{ color: C.text3 }}>Modal</Text>
                ...
                <View style={s.rangeItem}>
                  ...
                  <Text variant="titleSmall" style={{ color: C.red, fontWeight: '700' }}>
                    ₹{current_price.max_price.toFixed(0)}
                  </Text>
                </View>
              </View>
            )}
        ...
        <Card style={s.card}>
          <Card.Content style={{ gap: SP.md }}>
            <View style={s.cardHead}>
              ...
              <Text variant="titleMedium" style={s.cardTitle}>Tomorrow's Prediction</Text>
              <Chip
                compact
            ...
            <View style={s.predGrid}>
              {prediction.current_price != null && (
                <View style={s.predCol}>
                  <Text variant="labelSmall" style={s.gridLabel}>TODAY</Text>
              ...
              <View style={[s.predCol, prediction.current_price != null && { borderLeftWidth: 1, borderRightWidth: 1, borderColor: C.border }]}>
                <Text variant="labelSmall" style={s.gridLabel}>TOMORROW</Text>
              ...
              <View style={s.predCol}>
                <Text variant="labelSmall" style={s.gridLabel}>RANGE</Text>
...
const s = StyleSheet.create({
  ...
  gridLabel: { color: C.text3, letterSpacing: 1.2, textTransform: 'uppercase', fontSize: 9 },
